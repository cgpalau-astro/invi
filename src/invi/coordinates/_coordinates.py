...
def ICRS_to_FSR(w_icrs, prm_sun, v_lsr):
    ...
    w_icrs : np.array
        ...
        [r, delta, alpha, vr, mu_delta, mu_alpha_str]
...
def radec_to_equal_area(ra, dec):
    ...
    ea_1 = _invi.units.deg_to_rad(ra)*2.0/_np.pi
...
def equal_area_to_radec(ea_1, ea_2):
    ...
    ra = _invi.units.rad_to_deg(ea_1/2.0*_np.pi)
...
def alpha_to_ALPHA(s_alpha, varphi):
    """Stripping points relative to the progenitor alpha_i i={r, phi, z} ->
