...
class sos:
    ...
    def load(file_name, verbose=True):
        ...
        Note
        ----
        1)  'source_id' are converted to floats."""
...
class ibata:
    ...
    def load(file_name, cmd37_correction, verbose=True):
        ...
        Note
        ----
        1)  RA and Dec are J2000. Gaia-DR3 are J2016."""
        ...
        #Definition dictionary
        stars = {}
        stars['source_id'] = _np.asarray(df.Gaia.values[st], dtype=_np.int64)
        ...
        bprp, g = _invi.photometry.reddening.correction(stars['ICRS']['delta'], stars['ICRS']['alpha'],
