...
def frw(prm_gc, prm, T, N):
    ...
    ic = _invi.dicts.phase_space(ic_fsr, ic_icrs, prm_gc)
    ...
    orbit = _invi.dicts.phase_space(w_fsr, w_icrs, prm_gc)
...
def bck_frw(prm_gc, prm):
    ...
    #Dictionary including the initial condition
    ic = _invi.dicts.phase_space(ic_fsr_frw, ic_icrs_frw, prm_gc)
    ...
    orbit = _invi.dicts.phase_space(w_fsr_frw, w_icrs_frw, prm_gc)
