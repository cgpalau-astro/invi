"""naif: numerical analysis and integer combinations of frequencies

naif is a pure-python package for numerical analysis of
...
can be found in [Beraldo e Silva et al 2023]
(https://ui.adsabs.harvard.edu/abs/2023arXiv230304828B/abstract).
Please, cite this paper if you use naif."""
