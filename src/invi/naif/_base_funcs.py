"""Base functions for _spec module."""
...
__all__ = ["chi_p", "inner_prod", "mn_phi_om", "gs"]
...
def chi_p(t, p=1):
    ...
    return (2.**p*fact_p**2/fact_2p)*(1. + np.cos(2.*np.pi*t/T))**p
...
def inner_prod(t, u1_chi, u2):
    ...
    return (1./T)*scipy.integrate.simpson(integrand, x=t)
