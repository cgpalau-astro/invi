...
def compress_qsub(prm_job):
    ...
    Note
    ----
    1)  --threads=0 makes xz use up to as many threads as the processor
        supports.
    2)  The .tar file is eliminated after the compression.
    3)  Print information compressed file: xz -l file.tar.xz
    4)  Decompress file: xz -d file.tar.xz"""
...
#PBS -q small
#PBS -j oe
#PBS -o /home/cgarcia/trash/{prm_job['name']}_compress_output.log

tar --create --file=/home/cgarcia/{prm_job['name']}.tar /home/cgarcia/NBody/Runs/{prm_job['name']}/
xz --compress -4 --threads=0 --verbose /home/cgarcia/{prm_job['name']}.tar
echo "Terminated successfully"
rm /home/cgarcia/{prm_job['name']}.tar
xz --list /home/cgarcia/{prm_job['name']}.tar.xz
"""
