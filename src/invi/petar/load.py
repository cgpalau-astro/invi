...
Note
----
1)  Files are compressed with: gzip --best data.x"""
...
def mass(file_path, snapshot):
    """Mass of the stars in FSR from petar snapshot file 'data.snapshot.gz'."""
