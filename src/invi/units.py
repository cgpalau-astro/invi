...
#M_sun/kpc^2 to uM/uL^2
def Msuninvkpc2_to_uMinvuL2(x): return x*u.L**2.0/u.M

#M_sun/kpc^3 to uM/uL^3
def Msuninvkpc3_to_uMinvuL3(x): return x*u.L**3.0/u.M

#uM/uL^3 to M_sun/kpc^3
def uMinvuL3_to_Msuninvkpc3(x): return x/u.L**3.0*u.M
...
def uLinvUT2_to_kpcinvMyr2(x):
    return uL_to_kpc(invuT_to_invMyr(invuT_to_invMyr(x)))
